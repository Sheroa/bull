...
var hqb = {
	...
	tpl:{
		...
		success:function(){
			...
			buf.push('<div class="cont3">');
			buf.push('<p class="buy-ok">尊敬的用户，您已成功购买活期宝{{#money}}元，<br>可进入<a href="javascript:void(0);">个人中心-我的投资</a>栏目查看详情。<br>多谢您的支持，祝您投资愉快！</p>');
